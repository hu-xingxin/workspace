...
/**
 * @author huxingxin
 * @createTime 2021年08月22日 01:53:44
 * @Description
 */
public class QRCodeUtil {
    ...
    public static void qrCodeEncode(String encodeddata, File destFile) throws IOException {
        ...
        g.setBackground(Color.BLACK);   // 设置背景颜色（白色）
        g.clearRect(0, 0, 139, 139);    // 矩形 X、Y、width、height
        g.setColor(Color.WHITE);    // 设置图像颜色（黑色）
...
//              System.out.println("Output Decoded Data is：" + decodedData);
    ...
    public static void main(String[] args) {
        String filePath = System.getProperty("user.dir") + "/src/com/qrcode/qrcode.png";
