...
//        System.out.println(s);
     ...
     * @param text
     */
    public static void copyCellAndSetValue(XWPFTableCell sourceCell, XWPFTableCell targetCell, String text,XWPFRun xwpfRun) {
        //段落属性
        ...
        if (sourceParRuns != null && sourceParRuns.size() > 0) {
            ...
            if (runs != null && runs.size() > 0) {
                ...
                runs.get(0).setFontSize(xwpfRun.getFontSize());
                runs.get(0).setFontFamily(xwpfRun.getFontFamily());
            } else {
