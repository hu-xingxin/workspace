...
public class User {
    ...
    public void setLawFa(String lawFa) {
        this.lawFa = lawFa == null ? null : lawFa.trim();
    }
    ...
    public void setLedgerIcon(String ledgerIcon) {
        this.ledgerIcon = ledgerIcon == null ? null : ledgerIcon.trim();
    }
    ...
    public void setLoginPermission(String loginPermission) {
        this.loginPermission = loginPermission == null ? null : loginPermission.trim();
    }
}