    ...
    <div class="container">
        <div class="row" style="margin-top: 200px" align="center">
            <div  style="margin: 0 auto; width: 550px">
                <img src="${pageContext.request.contextPath}/static/img/chijin.gif" class="img-circle" style="width: 50px">
                <span style="font-family: fangsong;font-size: 30px;font-weight: bold"><font color="#7b68ee"> 404 </font>哎呀, 页面不见了</span>
                <img src="${pageContext.request.contextPath}/static/img/bug1.jpg" class="img-thumbnail" style="width: 150px">
            </div>
        </div>
    </div>
</body>
